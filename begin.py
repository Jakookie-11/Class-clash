...
def begin():
    ...
    print("║                     BETA TEST                    ║")
    print("║                                                  ║")
    print(f"║               Version {funktions.lokale_version_abrufen():<27}║")
    print("║                                                  ║")
    ...
    print("║                                                  ║")
    print("║  Wenn du wissen willst, wer bereits Fehler       ║")
    print("║  gemeldet hat, kannst du unter Einstellungen ->  ║")
    print("║  Credits nachschauen und auch was der Fehler war.║")
    print("║                                                  ║")
    print("║  Die Changelogs können jederzeit auf GitHub      ║")
    print("║  unter Releases nachgeschlagen werden.           ║")
    print("║                                                  ║")
